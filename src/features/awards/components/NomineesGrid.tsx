...
import { $selectedCategory, selectNominee } from '../../../shared/stores/uiStore';
import { getUserVotes } from '../lib/voting';
import { $currentUser } from '../../auth/stores/authStore';
import { TlagImage } from '../../../shared/components/TlagImage';
      ...
      {category.nominees.map((nominee: any) => {
        ...
        return (
          ...
          >
            ...
            <TlagImage src={thumbSrc} alt={nominee.name} width={400} className="w-full h-full object-cover transition-transform duration-300 group-hover:scale-110" />
